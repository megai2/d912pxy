...
3. Download latest release [from here](https://github.com/megai2/d912pxy/releases/tag/v0.9.4.1a)
...
3. Скачайте последний доступный релиз [ссылка](https://github.com/megai2/d912pxy/releases/tag/v0.9.4.1a)
